...
-- Group monitor must be inserted first so child monitors can reference its id.
INSERT INTO
    "main"."monitor" (
        "name",
        "active",
...
WHERE
    NOT EXISTS (
        SELECT 1 FROM "main"."monitor" WHERE "name" = 'Docker'
    );
...
SELECT
    ...
    NULL,
    NULL,
    (SELECT "id" FROM "main"."monitor" WHERE "name" = 'Docker'),
    '0',
    NULL,
    NULL,
    NULL,
...
WHERE
    NOT EXISTS (
        SELECT 1 FROM "main"."monitor" WHERE "name" = 'onionbalance'
    );
...
WHERE
    NOT EXISTS (
        SELECT 1 FROM "main"."monitor" WHERE "name" = 'octo'
    );
